...
SECRET_KEY = "django-insecure--5hgb0&yk@!*a(kkjy9*w806g7q@^2t0timz()$u-b$oaw_4%7"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="assa <noreply@assa.null.co>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[assa]"
)
...
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"  # temporarily, before we are confident in sending mail
