"""
File: ./tests/test_race_ethnicity_by_country.py
Starter: Mihaela
...
class TestRaceEthnicityByCountry(unittest.TestCase):
    """
    ...
    def test_multiple_entries(self):
        ...
        Will verify expected value of East Asian students.
        """
        input1 = '../data/stats.txt'
        devs_obj = Analysis(input1)
        actual_result = devs_obj.race_ethnicity_by_country().__getitem__(
            'East Asian'
        )
        expected_result = 93
    ...
    def test_empty_file(self):
        ...
        devs_obj = Analysis(input1)
        actual_result = devs_obj.race_ethnicity_by_country()
        expected_result = {}
        self.assertEqual(actual_result, expected_result)
